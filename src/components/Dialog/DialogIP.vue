          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <div style="font-size:24px">
                <i v-if="list.length > 1" style="color:#ff4949;margin-left: 10px;" @click="removeIp(scope.row.ip)"
                   class="el-icon-remove"></i>
                <i v-if="list.length - 1 === scope.$index" style="color:#1890ff;margin-left: 10px;" @click="addIp"
